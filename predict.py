...
if __name__ == '__main__':
    ...
    # img_files = [file for file in os.listdir(in_files)]
    # images = [Image.open(os.path.join(in_files, file)) for file in img_files]
    # masks = predict_img(net=net,full_img=test_data,device=device)
    # print(len(masks))
